...
const BottomNav = () => {
    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 bg-[#262626] p-2 h-16 flex justify-around">
            ...
            <button onClick={openModal} className="absolute bottom-6 bg-[#F6B100] text-[#f5f5f5] rounded-full p-3 item-center">
                <BiSolidDish size={30} />
            </button>
            ...
            <Modal isOpen={isModalOpen} onClose={closeModal} title="Create Order">
                ...
                <div>
                    ...
                    <div className="flex items-center rounded-lg p-3 px-4 bg-[#1f1f1f]">
                        <input type="number" name="" placeholder="(+1) 999999999" id="" className="bg-transparent flex-1 text-white focus:outline-none" />
                    </div>
                </div>
                ...
                <button onClick={() => navigate("/tables")} className="w-full bg-[#F6B100] text-[#f5f5f5] rounded-lg p-3 mt-8 hover:bg-yellow-700  duration-300">
                    Create Order
                </button>
